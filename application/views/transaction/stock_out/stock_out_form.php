        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="float-sm-right">
                    <a href="<?= site_url('stock/out') ?>" class="btn btn-info btn-sm"><i class="fa fa-undo"> Retour</i></a>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4 offset-md-4">
                        <form action="<?= site_url('stock/process'); ?>" method="post">
                            ...
                            <div class="form-group">
                                <label for="detail" class="col-form-label">Détails <font color="#f00">*</font></label>
                                <input type="text" name="detail" id="detail" class="form-control" placeholder="Périmé / Endommagé / Perdu" autofocus>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button class="btn btn-success btn-flat" type="submit" name="out_add"><i class="fa fa-paper-plane"></i> Enregistrer</button>
