        ...
        <div class="head">
            <table cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td style="text-align: right;">
                        <?= $sale->customer_id != null ? $sale->customer_name : "Général" ?>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="transaction">
            <table class="transaction-table" cellspacing="0" cellpadding="0">
                ...
                foreach ($arr_discount as $ad) { ?>
                    <tr>
                        <td></td>
                        <td colspan="2" style="text-align: right;">Réduc. <?= $ad + 1; ?></td>
                ...
                <tr>
                    <td colspan="2"></td>
                    <td style="text-align: right; padding-top:5px;">Sous Total</td>
                ...
                <?php if ($sale->discount > 0) { ?>
                    <tr>
                        <td colspan="2"></td>
                        <td style="text-align: right; padding-top:5px;">Réduc. Vente</td>
                        <td style="text-align: right; padding-top:5px;">
                ...
                <tr>
                    <td colspan="2"></td>
                    <td style="text-align: right; padding-top:5px;">Total Général</td>
                    <td style="text-align: right; padding-top:5px;">
                ...
                <tr>
                    <td colspan="2"></td>
                    <td style="text-align: right; padding-top:5px;">Espèces</td>
                    <td style="text-align: right; padding-top:5px;">
                ...
                <tr>
                    <td colspan="2"></td>
                    <td style="text-align: right;">Rendu</td>
                    <td style="text-align: right;">
