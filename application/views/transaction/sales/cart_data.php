    ...
    foreach ($cart->result() as $c) { ?>
        <tr>
            ...
            <td><?php if ($c->discount_item != 0) {
                    $argent = indo_currency($c->discount_item);
                } else {
                    $argent = $c->discount_item;
                } ?>
                <?= $argent; ?>
            </td>
...
<?php }
    ...
    echo '  <tr>
                <td colspan="9" class="text-center">Aucun article</td>
            </tr>';
} ?>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Modifier le panier</h5>
            ...
            <div class="modal-body">
                <form method="post" target="_self" name="formku" id="formku" class="eventInsForm">
                    <div class="form-row">
                        <label for="barcode_name" class="col-form-label">Produit</label>
                    ...
                    <div class="form-row">
                        <label for="item_qty">Quantité</label>
                        <input type="text" id="item_qty" name="item_qty" class="form-control">
                    </div>

                    <div class="form-row">
                        <label for="item_discount">Remise</label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" onclick="simpandata()"><i class="fa fa-paper-plane"></i> Enregistrer</button>
            </div>
        </div>
    </div>
</div>
