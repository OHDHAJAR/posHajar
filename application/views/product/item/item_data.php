        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Données des articles</li>
                </ol>
            </div>
        </div>
    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" target="_self" name="formku" id="formku" class="eventInsForm" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4 col-xs-4">
                                            <label for="nama_produk" class="col-form-label">Nom du produit <font color="#f00">*</font></label>
                                        </div>
                                        <div class="col-md-8 col-xs-8">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4 col-xs-4">
                                            <label for="category" class="col-form-label">Catégorie <font color="#f00">*</font></label>
                                        </div>
                                        <div class="col-md-8 col-xs-8">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4 col-xs-4">
                                            <label for="unit" class="col-form-label">Unité <font color="#f00">*</font></label>
                                        </div>
                                        <div class="col-md-8 col-xs-8">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4 col-xs-4">
                                            <label for="price" class="col-form-label">Prix <font color="#f00">*</font></label>
                                        </div>
                                        <div class="col-md-8 col-xs-8">
                                    ...
                                    <div class="form-row" id="input_photo" style="display:none;">
                                        <div class="col-md-4 col-xs-4">
                                            <label for="gambar" class="col-form-label">Photo du produit</label>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <small><i>Dimensions recommandées 128 x 128 pixels (jpg, png, jpeg)</i></small>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= site_url('item/barcode_qrcode/' . $i->item_id); ?>" class="btn btn-warning btn-sm">
                                                Générer <i class="fa fa-barcode"></i>
                                            </a>
                                        </td>
                                        <td><?= $i->name; ?></td>
