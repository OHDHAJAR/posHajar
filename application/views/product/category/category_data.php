        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Données Catégories</li>
                </ol>
            </div>
        </div>
    </div>
                                ...
                                <form method="post" target="_self" name="formku" id="formku" class="eventInsForm">
                                    <div class="form-row">
                                        <div class="col-md-4 col-xs-4">
                                            <label for="name" class="col-form-label">Nom de la Catégorie <font color="#f00">*</font></label>
                                        </div>
...
<script>
    ...
    function tambahData() {
        ...
        $("#myModal").find('.modal-title').text('Ajouter une catégorie');
        $("#myModal").modal('show', {
            backdrop: 'true'
        });
            ...
            if (dsState == "Input") {
                $.ajax({
                    ...
                    success: function(result) {
                        if (result == "ADA") {
                            $('.nama-ada').html("Le nom de la catégorie existe déjà !");
                            $('.nama-ada').show();
                        } else {
                            $('#message').html("");
                            $('.nama-ada').hide();
    ...
    function editData(category_id) {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $("#myModal").find('.modal-title').text('Modifier la catégorie');
                $("#myModal").modal('show', {
                    backdrop: 'true'
                });
            }
