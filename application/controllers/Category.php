...
class Category extends CI_Controller
{
    ...
    public function cek_category()
    {
        ...
        $return_data = ($cek_data) ? "il ya" : "il n'y  pas";
    ...
    public function save()
    {
        ...
        $this->session->set_flashdata('pesan', 'Données de catégories ajoutées avec succès.');
        redirect('category');
    }
    ...
    public function update()
    {
        ...
        $this->session->set_flashdata('pesan', 'Les données des catégories ont été mises à jour avec succès.');
        redirect('category');
    }
    ...
    public function delete()
    {
        ...
        $this->session->set_flashdata('pesan', 'Les données des catégories ont été supprimées avec succès!');
        redirect('category');
    }
}
